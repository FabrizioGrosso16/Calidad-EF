...
<div class="d-flex">
    ...
    <div class="container mt-4">
        ...
        <a class="btn btn-success mb-3" href="<%= request.getContextPath() %>/CategoriaProductoControlador?accion=nuevo">
        ...
        <table id="tablaCategorias" class="table table-bordered table-hover display nowrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-sm" href="<%= request.getContextPath() %>/CategoriaProductoControlador?accion=editar&id=<%= cp.getIdCategoriaProducto() %>">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <span>|</span>
                        <a class="btn btn-danger btn-sm" href="<%= request.getContextPath() %>/CategoriaProductoControlador?accion=eliminar&id=<%= cp.getIdCategoriaProducto() %>"

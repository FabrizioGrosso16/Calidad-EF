...
<%@ page import="java.util.*, pe.edu.modelo.Proveedor" %>
...
<div class="d-flex">
    ...
    <div class="container mt-4">
        ...
        <a class="btn btn-success mb-3" href="<%= request.getContextPath() %>/ProveedorControlador?accion=nuevo">Agregar Proveedor</a>
                ...
                %>
                    <tr>
                        ...
                        <%
                            ...
                            for (CategoriaProveedor c : (List<CategoriaProveedor>) request.getAttribute("categorias")) {
                                if (c.getIdCategoriaProveedor() == p.getIdCategoriaProveedor()) {
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="<%= request.getContextPath() %>/ProveedorControlador?accion=editar&id=<%= p.getIdProveedor() %>">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <span>|</span>
                            <a class="btn btn-danger btn-sm" href="<%= request.getContextPath() %>/ProveedorControlador?accion=eliminar&id=<%= p.getIdProveedor() %>" onclick="return confirm('¿Está seguro de eliminar este proveedor?');">

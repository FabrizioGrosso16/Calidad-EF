...
<head>
    <meta charset="UTF-8">
    <title>Lista de Inventario Total</title>
...
<div class="d-flex">
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Inventario Total</h1>

        <a class="btn btn-success mb-3" href="<%= request.getContextPath() %>/ListaInventarioTotalControlador?accion=nuevo">Agregar Inventario</a>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        <td><%= lit.getIdLIT() %></td>
                        <td>
                            <form action="<%= request.getContextPath() %>/ListaInventarioTotalControlador" method="post" class="d-flex">
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="<%= request.getContextPath() %>/ListaInventarioTotalControlador?accion=editar&id=<%= lit.getIdLIT() %>">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <span>|</span>
                            <a class="btn btn-danger btn-sm" href="<%= request.getContextPath() %>/ListaInventarioTotalControlador?accion=eliminar&id=<%= lit.getIdLIT() %>" onclick="return confirm('¿Está seguro de eliminar este inventario?');">

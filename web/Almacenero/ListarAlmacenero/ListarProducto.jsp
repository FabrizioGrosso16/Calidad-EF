<%-- 
    ...
    Created on : 26 may. 2025, 02:42:44
    Author     : User001
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Lista de Productos - Jefe de Almacen</title>
...
<div class="d-flex">
    <!-- Sidebar izquierdo para almacenero -->
    <jsp:include page="/Almacenero/Componentes/sidebar.jsp" />

    <div class="container mt-4">
        <h1 class="mb-4">Productos Registrados</h1>
        <a class="btn btn-success mb-3" href="<%= request.getContextPath() %>/ProductoControlador2?accion=nuevo">Agregar Producto</a>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td><%= nombreMarca %></td>
                        <td>
                            <a class="btn btn-primary btn-sm" href="<%= request.getContextPath() %>/ProductoControlador2?accion=editar&id=<%= p.getIdProducto() %>">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <span>|</span>
                            <a class="btn btn-danger btn-sm" href="<%= request.getContextPath() %>/ProductoControlador2?accion=eliminar&id=<%= p.getIdProducto() %>" onclick="return confirm('¿Está seguro de eliminar este producto?');">
        ...
        <a class="btn btn-secondary" href="/Almacenero/AlmaceneroIndex.jsp">Regresar</a>
    </div>
</div>

        ...
        try {
            ...
            switch (accion) {
                case "listar":
                    ...
                    request.getRequestDispatcher("Admin/ListarAdmin/ListarProducto.jsp").forward(request, response);
                    break;
                ...
                case "nuevo":
                    ...
                    request.getRequestDispatcher("Admin/AgregarAdmin/AgregarProducto.jsp").forward(request, response);
                    break;
                ...
                case "editar":
                    ...
                    request.getRequestDispatcher("Admin/EditarAdmin/EditarProducto.jsp").forward(request, response);
                    break;
